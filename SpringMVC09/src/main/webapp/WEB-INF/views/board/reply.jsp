    ...
    <div class="panel-body">
    	<form id="frm" method="post">
    		...
    		<div class="form-group">
    			<label>제목</label>
    			<input id="title" value="${vo.title}" type="text" name="title" class="form-control">
    		</div>
    		...
    		<div class="form-group">
    			<label>작성자</label>
    			<input id="wrtier" value="${mvo.memName}" readonly="readonly" type="text" name="writer" class="form-control">
    		</div>
