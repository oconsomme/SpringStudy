      ...
      <form action="">
         ...
         <!-- 중복체크는 키보드를 눌렀다가 떼면 자동으로 체크해야하는데 이는 onkeyup 속성을 이용한다. -->
            <tr>
               ...
               <td colspan="2"><input type="password" name="memPassword1" onkeyup="passwordCheck()" id="memPassword1" class="form-control" maxlength="20" placeholder="비밀번호를 입력하세요."></td>
            </tr>
            <tr>
