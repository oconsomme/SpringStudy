                   ...
                   <form id="regForm" action="${cpath}/board/register" method="post">
                      ...
                      <div id="regDiv">
                   	  ...
                   	  <div id="updateDiv" style="display:none;">
                   	  	  <button class="btn btn-sm btn-primary" type="button" data-oper="list">목록</button>
                   	  	  <span id="update">
                   	  	  <button class="btn btn-sm btn-warning" type="button" data-oper="updateForm">수정</button>
                   	  	  </span>
                   	  	  <button class="btn btn-sm btn-success"type="button" data-oper="remove">삭제</button>
                   	  </div>
                   </form>
                </div>
             </div>
